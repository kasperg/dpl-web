      ...
      <div className="fee-list" data-cy="fee-list">
        ...
        <div className="fee-list-bottom">
          <div className="fee-list-bottom__actions">
            <p className="text-small-caption color-secondary-gray">
              Har du allerede betalt? Der kan gå op til 72 timer før betalingen
              registreres i vores systemer
            </p>
        ...
        >
          <div className="list-reservation__material">
            ...
            <div className="list-reservation__information">
              ...
              <div className="list-reservation__about">
                <h3 className="text-header-h4">
                  Johannesevangeliets klarhed : en læsning for præster og andre
                  nysgerrige
                </h3>
                <p className="text-small-caption color-secondary-gray">
